...
const CURATED: Record<string, CuratedEntry[]> = {
  ...
  asturias: [
    ...
    { name: "Gijón", lat: 43.5453, lng: -5.6620 },
    { name: "Avilés", lat: 43.5560, lng: -5.9248 },
    { name: "Cangas de Onís", lat: 43.3494, lng: -5.1271 },
    { name: "Llanes", lat: 43.4208, lng: -4.7547 },
    { name: "Ribadesella", lat: 43.4610, lng: -5.0596 },
    { name: "Cudillero", lat: 43.5525, lng: -6.1456 },
    { name: "Covadonga", lat: 43.3090, lng: -5.0330 },
    { name: "Luanco", lat: 43.6167, lng: -5.7833 },
    { name: "Lastres", lat: 43.5150, lng: -5.1200 },
  ],
  galicia: [
    { name: "Santiago de Compostela", lat: 42.8782, lng: -8.5448 },
    ...
    { name: "Lugo", lat: 43.0097, lng: -7.5568 },
    { name: "Pontevedra", lat: 42.4310, lng: -8.6444 },
    { name: "Cambados", lat: 42.1212, lng: -8.7133 },
    { name: "Finisterre", lat: 42.9053, lng: -9.2628 },
  ],
  cantabria: [
    { name: "Santander", lat: 43.4623, lng: -3.8100 },
    { name: "Comillas", lat: 43.3870, lng: -4.2920 },
    { name: "San Vicente de la Barquera", lat: 43.3850, lng: -4.3980 },
    { name: "Potes", lat: 43.1539, lng: -4.6230 },
  ],
  andalucia: [
    { name: "Sevilla", lat: 37.3891, lng: -5.9845 },
    { name: "Granada", lat: 37.1773, lng: -3.5986 },
    ...
    { name: "Málaga", lat: 36.7213, lng: -4.4214 },
    { name: "Cádiz", lat: 36.5271, lng: -6.2886 },
    { name: "Ronda", lat: 36.7420, lng: -5.1671 },
    { name: "Carmona", lat: 37.4712, lng: -5.6461 },
  ],
  andalucía: [
    { name: "Sevilla", lat: 37.3891, lng: -5.9845 },
    { name: "Granada", lat: 37.1773, lng: -3.5986 },
