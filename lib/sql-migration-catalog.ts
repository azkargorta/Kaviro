...
export const SQL_MIGRATION_CATALOG: SqlMigrationDefinition[] = [
  ...
  {
    id: "agency_payment_receipts",
    file: "kaviro_agency_payment_receipts.sql",
    label: "Justificantes y cobros manuales (transferencia)",
    group: "b2b",
    order: 14.5,
  ...
  {
    id: "trip_mode",
    file: "kaviro_trip_mode.sql",
    label: "Modo grupo de gastos (trip_mode)",
    group: "b2c",
    order: 8.5,
  ...
  {
    id: "agency_template_includes",
    file: "kaviro_agency_template_includes.sql",
    label: "Plantillas: bloques a clonar (includes)",
    group: "b2b",
    order: 20,
    optional: true,
    check: { kind: "column", table: "agency_templates", column: "includes" },
  },
  {
    id: "agency_announcements_rls",
    file: "kaviro_agency_announcements_participants.sql",
    label: "RLS avisos agencia para participantes",
    group: "b2b",
    order: 21,
    optional: true,
    check: { kind: "table", table: "agency_trip_announcements" },
  },
  {
    id: "plan_ratings",
