...
| Tipos actividades/rutas | ✅ `lib/trip-activities/*`, `lib/trip-routes/payload` + tests |
...
|-------|-----------|-------|
| Travel mates UI | ✅ mejorado | `user_travel_mates` + co-ocurrencia; panel participantes; sección `/account`; invitaciones pendientes |
