...
- [x] Bloque calidad (parcial): trip-ai sin `as any` en `itineraryValidator`, `itinerarySanity`, `executePlanOnTrip`, `generateItineraryFromIntent` (normalización); tests `itineraryItemUtils.test.ts`
