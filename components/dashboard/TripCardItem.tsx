...
export default function TripCardItem({
  ...
  return (
    <div
      ...
      className={`rounded-3xl border bg-gradient-to-br p-5 shadow-sm ${accent} dark:border-[#1E293B] dark:from-[#0F1623] dark:via-[#0F1623] dark:to-[#0F1623] ${
        locked ? "opacity-80" : "cursor-pointer transition hover:-translate-y-0.5 hover:shadow-md"
      }`}
    >
      <div className="flex items-start justify-between gap-4">
        <div className="space-y-2">
          <div className="inline-flex items-center rounded-full bg-white/70 px-3 py-1 text-[11px] font-semibold uppercase tracking-[0.18em] text-slate-700 dark:bg-[#F87171]/15 dark:text-[#FCA5A5] dark:border dark:border-[#F87171]/20">
            {badge}
          </div>
          <div>
