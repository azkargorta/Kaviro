          ...
          <div className="grid items-center gap-10 lg:grid-cols-[minmax(0,1fr)_minmax(0,1.15fr)] lg:gap-12 xl:gap-16">
            ...
            <Reveal variant="scale" delay={1} className="relative lg:justify-self-end">
              <div className="hero-float relative mx-auto w-full max-w-lg lg:max-w-none">
                <div
                  className="pointer-events-none absolute -left-4 top-8 z-10 hidden rounded-xl border border-slate-200 bg-white px-3 py-2 text-xs font-semibold text-slate-700 shadow-md sm:block dark:border-[#1E293B] dark:bg-[#0F1623] dark:text-slate-200"
                  aria-hidden
                >
                  <span className="text-[var(--brand)]">€342</span> · gastos del grupo
                </div>
                <div
                  className="pointer-events-none absolute -right-2 bottom-16 z-10 hidden rounded-xl border border-slate-200 bg-white px-3 py-2 text-xs font-semibold text-slate-700 shadow-md sm:block dark:border-[#1E293B] dark:bg-[#0F1623] dark:text-slate-200"
                  aria-hidden
                >
                  3 participantes · en vivo
                </div>
                <div className="rounded-[1.35rem] shadow-2xl shadow-slate-900/10 ring-1 ring-slate-200/80 dark:shadow-black/40 dark:ring-[#1E293B]">
                  <PlanItineraryCard
