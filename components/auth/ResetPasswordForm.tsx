...
export default function ResetPasswordForm() {
  ...
  return (
    <div className="space-y-6">
      ...
      {!ready && !error ? (
        <div className="rounded-2xl border border-slate-200 bg-slate-50 dark:bg-[#080C14] px-4 py-3 text-sm text-slate-700 dark:text-slate-300">
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        <div>
          <label className="mb-2 block text-sm font-semibold text-slate-700 dark:text-slate-300">Contraseña nueva</label>
          <div className="relative">
              <input
                ...
                placeholder="••••••••"
              />
              <button type="button" onClick={() => setShowPassword((v) => !v)} className="absolute right-3 top-1/2 -translate-y-1/2 rounded-lg p-1 text-slate-400 hover:text-slate-700 dark:text-slate-300 transition" aria-label={showPassword ? "Ocultar" : "Mostrar"} tabIndex={-1}>
        ...
        <div>
          <label className="mb-2 block text-sm font-semibold text-slate-700 dark:text-slate-300">Repite contraseña</label>
          <div className="relative">
              <input
                ...
                placeholder="••••••••"
              />
              <button type="button" onClick={() => setShowConfirm((v) => !v)} className="absolute right-3 top-1/2 -translate-y-1/2 rounded-lg p-1 text-slate-400 hover:text-slate-700 dark:text-slate-300 transition" aria-label={showConfirm ? "Ocultar" : "Mostrar"} tabIndex={-1}>
