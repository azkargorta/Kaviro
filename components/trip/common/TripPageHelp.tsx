...
const TAB_TOUR: TourStep[] = [
  ...
  },
  {
    ...
    title: "Plan",
    lead: "Paso 2 de 7",
    body: "Itinerario coral, IA sugiere, visibilidad por actividad, RSVP y pestaña Asistencia del grupo.",
    ...
    blocks: [
      {
        ...
        bullets: [
          ...
          "Responder RSVP (Sí / No / Quizás) en el detalle de cada actividad.",
          "Abrir la pestaña Asistencia para ver quién va a cada plan, pendientes y totales por día.",
          "Exportar PDF, historial, explorar en mapa y vista calendario.",
        ],
      },
      {
        heading: "Ventajas",
