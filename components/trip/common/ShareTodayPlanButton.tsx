...
export default function ShareTodayPlanButton({
  ...
  const heroClass =
    "inline-flex shrink-0 min-h-9 items-center justify-center gap-1.5 rounded-lg border border-white/35 bg-white/15 px-2.5 py-1.5 text-[11px] font-bold text-white transition hover:bg-white/25 disabled:opacity-60";
