...
export default function TripScreenActions({
  ...
  const desktopIconTile =
    "inline-flex h-9 w-9 items-center justify-center overflow-hidden rounded-full border border-slate-200 bg-white text-slate-900 shadow-sm dark:border-[#334155] dark:bg-[#1E293B] dark:text-white";
    ...
    <div className="flex min-w-0 max-w-full flex-wrap gap-2">
      ...
      <Link href="/dashboard" className={btn} aria-label={homeLabel} title={homeLabel}>
        <span className={desktopIconTile} aria-hidden>
          <Home className="h-6 w-6 text-slate-900 dark:text-[#F87171]" aria-hidden />
        </span>
