              ...
              {currentUserId && (
                <div className="space-y-2">
                  ...
                  <div className="flex gap-2">
                    ...
                    />
                    {myReaction && (
                      <button type="button" disabled={saving || !comment.trim()} onClick={() => vote(myReaction.reaction)} className="rounded-xl bg-[var(--brand)] px-3 py-1.5 text-white disabled:opacity-40">
