...
export default function MobileBottomNav({ tripId, isPremium }: Props) {
  ...
  return (
    ...
    >
      ...
      <div className="mx-2 mb-1 overflow-hidden rounded-2xl border border-slate-200/90 bg-[var(--surface-card)]/96 shadow-[0_-4px_24px_rgba(15,23,42,0.10)] backdrop-blur-xl dark:shadow-[0_-4px_24px_rgba(0,0,0,0.4)] dark:border-[#1E293B]">
        <div className="flex">
            ...
            return (
              <Link
                ...
                className={`
                  ...
                  ${active ? "text-slate-950 dark:text-white" : "text-slate-500 dark:text-slate-500 hover:text-slate-700 dark:hover:text-slate-300"}
                `}
                title={item.label}
              >
                {/* Active pill bg */}
